 ...
 * @access private
 */
 namespace apmc\admin\classwplisttable;
 if ( !defined( 'ABSPATH' ) ) {
     exit;
 }
class WP_List_Table {
...
<p class="search-box">
	...
	protected function bulk_actions( $which = '' ) {
		...
		echo "</select>\n";
    $msg = "Are you sure you want to delete the selected Marquees?";
		submit_button( __( 'Apply' ), 'action', '', false, array( 'id' => "doaction$two",'onclick'=>'return confirm('."'".$msg."'".')' ) );
		echo "\n";
	}
	...
	protected function get_default_primary_column_name() {
		...
		// We need a primary definedd so responsive views show something,
